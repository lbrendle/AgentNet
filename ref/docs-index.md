# AgentNet Documentation Index

This index defines the documentation set, its scope, and the expected operational use for each document.

---

## 1) Strategy and architecture
- `ref/implementation-plan.md` - end-to-end build plan and acceptance criteria
...
- `ref/repo-organization.md` - repo structure and ownership boundaries
...
## 5) Guides
- `ref/guides/operator-guide.md`
- `ref/guides/developer-guide.md`
- `ref/guides/governance-guide.md`
- `ref/guides/security-guide.md`
...
- No placeholder logic, mock flows, or non-production data.
- Every procedure must be executable and auditable.
- All policies must be enforceable by the system, not just advisory text.
